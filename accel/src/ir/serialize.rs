...
use super::op::{Op, OpIdx, MAX_OP_ARGS};
use super::opcode::Opcode;
use super::temp::{Temp, TempIdx, TempKind};
...
fn deserialize_one_tb(
    ...
    for i in 0..temp_count {
        ...
        temps.push(Temp {
            ...
            kind,
            val_type: match kind {
                TempKind::Const => super::types::TempVal::Const,
                TempKind::Fixed => super::types::TempVal::Reg,
                TempKind::Global => super::types::TempVal::Mem,
                _ => super::types::TempVal::Dead,
            },
            reg,
